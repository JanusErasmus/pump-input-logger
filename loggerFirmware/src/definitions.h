...
#define SECTOR_DATA		0x000000
#define SECTOR_STATUS	0x010000
#define SECTOR_HOBBS	0x020000
#define SECTOR_LOGS		0x040000  //Logs stored in sectors 4 through 6

//Stack and thread definitions
#define INIT_PRIOR		14
...
#define SYSMON_STACK_SIZE	CYGNUM_HAL_STACK_SIZE_TYPICAL*3
