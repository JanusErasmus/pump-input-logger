...
#define CYGNUM_LIBC_MAIN_THREAD_PRIORITY 15
#define CYGNUM_LIBC_MAIN_THREAD_PRIORITY_15
#define CYGNUM_LIBC_MAIN_DEFAULT_STACK_SIZE 256
#define CYGNUM_LIBC_MAIN_DEFAULT_STACK_SIZE_256
