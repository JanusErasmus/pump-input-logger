...
// UART GPIO pins
#ifdef CYGHWR_HAL_STM32_UART0_REMAP
#define CYGHWR_HAL_STM32_UART1_REMAP_CONFIG CYGHWR_HAL_STM32_AFIO_MAPR_URT1_RMP
#define CYGHWR_HAL_STM32_UART1_RX               CYGHWR_HAL_STM32_GPIO( B,  7, IN        , FLOATING      )
#define CYGHWR_HAL_STM32_UART1_TX               CYGHWR_HAL_STM32_GPIO( B,  6, OUT_50MHZ , ALT_PUSHPULL  )
#else
...
#ifdef CYGHWR_HAL_STM32_UART1_REMAP
#define CYGHWR_HAL_STM32_UART2_REMAP_CONFIG CYGHWR_HAL_STM32_AFIO_MAPR_URT2_RMP
#define CYGHWR_HAL_STM32_UART2_RX               CYGHWR_HAL_STM32_GPIO( D,  6, IN        , FLOATING      )
#define CYGHWR_HAL_STM32_UART2_TX               CYGHWR_HAL_STM32_GPIO( D,  5, OUT_50MHZ , ALT_PUSHPULL  )
#define CYGHWR_HAL_STM32_UART2_CTS              CYGHWR_HAL_STM32_GPIO( D,  3, IN        , FLOATING      )
#define CYGHWR_HAL_STM32_UART2_RTS              CYGHWR_HAL_STM32_GPIO( D,  4, OUT_50MHZ , OUT_PUSHPULL  )
#else
...
#if defined(CYGHWR_HAL_STM32_UART2_REMAP_FULL)
#define CYGHWR_HAL_STM32_UART3_REMAP_CONFIG CYGHWR_HAL_STM32_AFIO_MAPR_URT3_FL_RMP
#define CYGHWR_HAL_STM32_UART3_RX               CYGHWR_HAL_STM32_GPIO( D, 9, IN        , FLOATING      )
#define CYGHWR_HAL_STM32_UART3_TX               CYGHWR_HAL_STM32_GPIO( D, 8, OUT_50MHZ , ALT_PUSHPULL  )
#define CYGHWR_HAL_STM32_UART3_CTS              CYGHWR_HAL_STM32_GPIO( D, 11, IN        , FLOATING      )
#define CYGHWR_HAL_STM32_UART3_RTS              CYGHWR_HAL_STM32_GPIO( D, 12, OUT_50MHZ , OUT_PUSHPULL  )
#elsif defined(CYGHWR_HAL_STM32_UART2_REMAP_PARTIAL)
#define CYGHWR_HAL_STM32_UART3_REMAP_CONFIG CYGHWR_HAL_STM32_AFIO_MAPR_URT3_P1_RMP
#define CYGHWR_HAL_STM32_UART3_RX               CYGHWR_HAL_STM32_GPIO( C, 11, IN        , FLOATING      )
#define CYGHWR_HAL_STM32_UART3_TX               CYGHWR_HAL_STM32_GPIO( C, 10, OUT_50MHZ , ALT_PUSHPULL  )
...
#define CYGHWR_HAL_STM32_I2C_CCR_FS			BIT_(15)
